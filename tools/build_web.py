...
"""
tools/build_web.py — assemble the browser build into docs/form/.
...
OUT = os.path.join(REPO, "docs", "form")
...
def main():
    ...
    print(f"  {len(FORMS)} blank forms -> docs/form/forms/")
